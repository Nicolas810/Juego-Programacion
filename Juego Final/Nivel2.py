...
class Enemigo(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.image = pygame.image.load("camelloant.png").convert()
...
class Protagonista(pygame.sprite.Sprite) :
	def __init__(self):
		...
		self.image = pygame.image.load("defensorant.png").convert()
...
class Torre(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.image = pygame.image.load("torreant.png").convert()
...
fondo1 = pygame.image.load("fondoant.jpg")
jabali = Enemigo()
cueva = Torre()
