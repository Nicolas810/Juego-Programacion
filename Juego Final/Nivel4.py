...
class Enemigo(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.image = pygame.image.load("caballomod.png").convert()
...
class Protagonista(pygame.sprite.Sprite) :
	def __init__(self):
		...
		self.image = pygame.image.load("indigenamod.png").convert()
		self.image = pygame.transform.scale(self.image, (100, 110))
		self.image.set_colorkey(BLANCO)
		self.image.set_colorkey(NEGRO)
		
		self.rect = self.image.get_rect()
		self.rect.centerx = ancho/8
		self.rect.centery = alto-240
...
class Torre(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.image = pygame.image.load("torremod.png").convert()
		self.image = pygame.transform.scale(self.image, (160, 140))
		self.image.set_colorkey(BLANCO)
		self.image.set_colorkey(NEGRO)
		
		self.rect = self.image.get_rect()
		self.rect.centerx = ancho/11
		self.rect.centery = alto-120
...
class Objeto(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.image = pygame.image.load("flechamod.png").convert()
...
fondo1 = pygame.image.load("fondomod.jpg")
jabali = Enemigo()
cueva = Torre()
