...
class Objeto(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.objeto1 = pygame.image.load("lanzapre.png").convert()
		self.objeto1 = pygame.transform.scale(self.objeto1, (150, 70))
		self.objeto1.set_colorkey(BLANCO)
		
		self.rect = self.objeto1.get_rect()
